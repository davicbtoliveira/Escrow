...
@shared_task(  # type: ignore[untyped-decorator]
    name="escrow.delivery.enqueue_expired_inspection_releases"
)
def enqueue_expired_inspection_releases_task() -> int:
    """Ask PostgreSQL which inspections passed their seven-day window."""
    return enqueue_expired_inspection_releases()
